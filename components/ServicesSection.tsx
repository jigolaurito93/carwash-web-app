...
const ServicesSection = () => {
  return (
    <div className="px-6 pt-6 pb-16 font-questrial md:px-24 lg:px-40">
      <div className="py-10 text-center font-lexend text-3xl">
      ...
      <div className="flex flex-wrap items-stretch justify-center gap-7">
        {servicesList.map((service) => (
          ...
          <div
            key={service.title}
            className="flex w-full max-w-80 flex-col gap-5 rounded-md border border-black/30 p-4 shadow-lg xl:pb-10"
          >
            ...
            <div className="flex min-h-0 flex-1 flex-col gap-2 pl-2">
              {service.features.map((feature) => (
                <div key={feature} className="flex items-center gap-3">
                  <MdLocalCarWash className="shrink-0 text-lg" />
